## concert_services (indigo) - 0.1.12-0

The packages in the `concert_services` repository were released into the `indigo` distro by running `/usr/bin/bloom-release concert_services -t indigo -r indigo` on `Thu, 09 Jul 2015 06:06:42 -0000`
...
## concert_services (indigo) - 0.1.11-0

The packages in the `concert_services` repository were released into the `indigo` distro by running `/usr/bin/bloom-release concert_services -t indigo -r indigo` on `Mon, 27 Apr 2015 06:01:49 -0000`
...
## concert_services (indigo) - 0.1.10-0

The packages in the `concert_services` repository were released into the `indigo` distro by running `/usr/bin/bloom-release concert_services -t indigo -r indigo` on `Mon, 06 Apr 2015 09:57:21 -0000`
...
## concert_services (indigo) - 0.1.9-0

The packages in the `concert_services` repository were released into the `indigo` distro by running `/usr/bin/bloom-release concert_services -t indigo -r indigo` on `Mon, 23 Mar 2015 08:51:44 -0000`
...
## concert_services (indigo) - 0.1.8-0

The packages in the `concert_services` repository were released into the `indigo` distro by running `/usr/bin/bloom-release concert_services -t indigo -r indigo` on `Fri, 27 Feb 2015 07:41:00 -0000`
...
## concert_services (indigo) - 0.1.7-0
