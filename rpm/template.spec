Name:           ros-indigo-concert-service-initialisation
Version:        0.1.2
Release:        0%{?dist}
Summary:        ROS concert_service_initialisation package

Group:          Development/Libraries
License:        BSD
URL:            http://ros.org/wiki/concert_service_initialisation
...
%description
Services to initilise environment. Make a map and annotation
